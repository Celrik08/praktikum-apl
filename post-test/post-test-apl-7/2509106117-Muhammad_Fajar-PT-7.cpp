...
void tambah_barang(Barang *barang, int &jumlah_barang){
    ...
    try{
        ...
        if(ptr->nama_barang.empty()){
            throw runtime_error("Nama barang tidak boleh kosong!, silahkan isi data lagi dengan benar");
        }
        ...
        if(ptr->jenis_barang.kategori.empty()){
            throw runtime_error("Jenis barang tidak boleh kosong!, silahkan isi data lagi dengan benar");
        }
        ...
        if(ptr->harga_barang <= 0){
            throw runtime_error("Harga barang harus lebih dari 0!, silahkan isi data lagi dengan benar");
        }
        ...
        if(ptr->stok < 0){
            throw runtime_error("Stok barang tidak boleh minus!, silahkan isi data lagi dengan benar");
        }
    ...
    try{
        ...
        for(int i=0;i<jumlah_barang;i++){
            ...
            if((barang+i)->id == id){
                ...
                if(harga_baru < 0){
                    throw runtime_error("Harga tidak boleh negatif!, silahkan ubah data dengan benar");
                }
                ...
                if(stok_baru < 0){
                    throw runtime_error("Stok tidak boleh negatif!, silahkan ubah data dengan benar");
                }
        ...
        if(!ditemukan){
            throw runtime_error("ID barang tidak ditemukan!, silahkan ubah data dengan benar");
        }
    }
    catch(exception &e){
        cout<<"Error: "<<e.what()<<endl;
...
void hapus_barang(Barang *barang, int *jumlah_barang){
    ...
    try{
        ...
        if(!ditemukan){
            throw runtime_error("ID barang tidak ditemukan!, silahkan hapus data dengan benar");
        }
    }
    catch(exception &e){
        cout<<"Error: "<<e.what()<<endl;
        ...
        if(pilih == 1){
            ...
            try{
                ...
                if(hasil != -1){
                    ...
                    throw runtime_error("Data yang anda cari tidak ditemukan");
                }
            }
            catch(exception &e){
            cout<<"Error: "<<e.what()<<endl;
